...
The Ionic \citep{ionic} framework is used in vodle, extending Angular's functionality by enabling the creation of responsive, mobile-compatible applications from a single codebase. Given vodle's goal of broad user participation, Ionic ensures consistent functionality across both desktop and mobile devices. %need to make sure its compatible 
