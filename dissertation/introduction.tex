...
In a representative democracy, citizens elect officials to deliberate and decide on legislation and policies on their behalf. While this system is more scalable than direct democracy, it introduces certain limitations:
% vote based on party lines, personal convictions, or special interests rather than strictly reflecting constituent preferences
% time btwn elections - unresponsive to rapidly evolving public opinion
% need to find references and write up -  can use blum + zuber 
