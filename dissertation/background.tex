...
\subsection*{Vote Splitting -- TODO: ADD DIAGRAMS}\label{subsec:vote_splitting_background}
...
\subsubsection*{Trust Matrix Model (proposed by Heitzig) -- TODO: convergence + performance implications}
...
% \begin{table}[H]
%   \centering
%   \caption{Comparison of Vote Splitting Mechanisms}
